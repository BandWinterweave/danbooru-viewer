import { Columns3, Download, Grid2X2, List, LoaderCircle, PanelLeftOpen, Rows3, Sparkles, X } from 'lucide-react';
...
import { ComfyWorkbench } from '../comfy/ComfyWorkbench';
...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    backgroundRef.current.inert = detailOpen || comfyOpen;
  }, [detailOpen, comfyOpen]);
